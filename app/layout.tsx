            ...
            <div className="w-full lg:w-3/4 mx-auto flex flex-col lg:flex-row gap-y-6 justify-between my-5 lg:mb-12 lg:mt-2">
              <div className="flex flex-col gap-y-3 justify-center items-center">
                ...
                <ul className="flex gap-x-4">
                  ...
                  <li className="stroke-white"><Link  href="http://warpcast.com/gilalter.eth" ><Image width="22" height="20" src="https://farconic.xyz/wp-content/uploads/2024/04/Farcaster-transparent-white-icon-1-1.png" alt="Farcaster" sizes="(max-width: 22px) 100vw, 22px" /></Link> </li>
                </ul>
              </div>
              <div className="flex flex-col gap-y-3 justify-center items-center">
                <figure>
            ...
            <div className="my-5">
              ...
              <div className="px-14 lg-px-0 mx-auto my-10 lg:mt-8 flex flex-col lg:flex-row gap-y-8 justify-center">
                <div className="w-fit mr-4 flex gap-x-10 lg:gap-x-8 justify-center items-center">
                  ...
                  <figure ><Link href="https://www.fastcompany.com/3029992/city-landmarks-distilled-into-their-basic-shapes"><Image className="w-24" width="567" height="89" src="https://farconic.xyz/wp-content/uploads/2024/05/fastcompany-4.png" alt="" sizes="(max-width: 567px) 100vw, 567px" /></Link> </figure>
                  <figure ><Link href="https://gizmodo.com/these-gorgeous-screenprints-showcase-a-citys-most-famo-1540461547"><Image className="w-24" width="982" height="148" src="https://farconic.xyz/wp-content/uploads/2024/05/Monosnap-gizmodo-logo-Google-Search-2024-05-11-12-40-25-3.png" alt="" sizes="(max-width: 982px) 100vw, 982px" /></Link> </figure>
                  <figure ><Link href="https://www.creativereview.co.uk/work/submission-shapes-cities-game/"><Image className="w-24" width="436" height="230" src="https://farconic.xyz/wp-content/uploads/2024/05/Monosnap-Shapes-of-Cities-learn-about-iconic-buildings-in-Yoni-Alters-iOS-memory-game-2024-05-11-12-33-42-2.png" alt="" sizes="(max-width: 436px) 100vw, 436px" /></Link> </figure>
                </div>
                <div className="ml-4 flex gap-x-10 lg:gap-x-8 justify-center items-center">
                  <figure ><Link href="widewalls.ch/artists/yoni-alter"><Image className="w-24" width="504" height="100" src="https://farconic.xyz/wp-content/uploads/2024/05/images-3.png" alt="" sizes="(max-width: 504px) 100vw, 504px" /></Link> </figure>
                  <figure ><Link href="https://www.printmag.com/color-design/famous-skylines-interpreted-with-art/"><Image className="w-24" width="704" height="216" src="https://farconic.xyz/wp-content/uploads/2024/05/Monosnap-2-Facebook-2024-05-11-12-31-33-2.png" alt="" sizes="(max-width: 704px) 100vw, 704px" /></Link> </figure>
                  <figure ><Link href="https://www.designweek.co.uk/inspiration/shapes-cities-app-yoni-alter/"><Image className="w-24" width="354" height="160" src="https://farconic.xyz/wp-content/uploads/2024/05/Monosnap-Shapes-of-Cities-app-by-Yoni-Alter-Design-Week-2024-05-11-12-28-21-2.png" alt="" sizes="(max-width: 354px) 100vw, 354px" /></Link> </figure>
                  <figure ><Link href="designboom.com/design/shapes-of-cities-yoni-alter-09-10-2015/"><Image className="w-24" width="2400" height="1200" src="https://farconic.xyz/wp-content/uploads/2024/05/image-asset-2.png" alt="" sizes="(max-width: 2400px) 100vw, 2400px" /></Link> </figure>
                </div>
              </div>
            </div>
        </footer>
